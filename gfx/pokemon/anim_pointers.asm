AnimationPointers:
	...
	dw MewtwoAnimation
	dw MewAnimation
	dw LullabearAnimation
	dw TeddyawnAnimation
	dw UrsamimirAnimation
	dw PupageAnimation
	dw StaguardAnimation
	dw MandibladeAnimation
	dw ReptripAnimation
	dw RavetileAnimation
	dw HallucigonAnimation
	dw SentretAnimation
	dw FurretAnimation
