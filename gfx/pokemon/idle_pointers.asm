AnimationIdlePointers:
	...
	dw MewAnimationIdle
	dw LullabearAnimationIdle
	dw TeddyawnAnimationIdle
	dw UrsamimirAnimationIdle
	dw PupageAnimationIdle
	dw StaguardAnimationIdle
	dw MandibladeAnimationIdle
	dw ReptripAnimationIdle
	dw RavetileAnimationIdle
	dw HallucigonAnimationIdle
