...
HallucigonFrontpic:  INCBIN "gfx/pokemon/hallucigon/front.animated.2bpp.lz"
...
UrsamimirFrontpic:    INCBIN "gfx/pokemon/ursamimir/front.animated.2bpp.lz"
...
BeedrillFrontpic:    INCBIN "gfx/pokemon/geodent/front.animated.2bpp.lz"
...
StaguardFrontpic:     INCBIN "gfx/pokemon/staguard/front.animated.2bpp.lz"
HoothootFrontpic:    INCBIN "gfx/pokemon/hoothoot/front.animated.2bpp.lz"
HordePic:            INCBIN "gfx/trainers/horde.2bpp.lz"


SECTION "Pics 3", ROMX

SteelixFrontpic:     INCBIN "gfx/pokemon/moggibox/front.animated.2bpp.lz"
...
HarlyenaFrontpic:     INCBIN "gfx/pokemon/harlyena/front.animated.2bpp.lz"
...
PupageFrontpic:   INCBIN "gfx/pokemon/pupage/front.animated.2bpp.lz"
HitmonchanFrontpic:  INCBIN "gfx/pokemon/hitmonchan/front.animated.2bpp.lz"
QuagsireFrontpic:    INCBIN "gfx/pokemon/toxicroak/front.animated.2bpp.lz"
...
OnixFrontpic:        INCBIN "gfx/pokemon/pugilhiss/front.animated.2bpp.lz"
...
RavetileFrontpic:    INCBIN "gfx/pokemon/ravetile/front.animated.2bpp.lz"
...
AmpharosFrontpic:    INCBIN "gfx/pokemon/cyclizar/front.animated.2bpp.lz"
...
TeddyawnFrontpic:     INCBIN "gfx/pokemon/teddyawn/front.animated.2bpp.lz"
...
WigglytuffFrontpic:  INCBIN "gfx/pokemon/togepi/front.animated.2bpp.lz"
...
ClefableFrontpic:    INCBIN "gfx/pokemon/maractus/front.animated.2bpp.lz"
...
LullabearFrontpic:   INCBIN "gfx/pokemon/lullabear/front.animated.2bpp.lz"
...
FlaaffyFrontpic:     INCBIN "gfx/pokemon/pallazap/front.animated.2bpp.lz"
...
ReptripFrontpic:    INCBIN "gfx/pokemon/reptrip/front.animated.2bpp.lz"
...
JigglypuffFrontpic:  INCBIN "gfx/pokemon/blossaroma/front.animated.2bpp.lz"
...
MareepFrontpic:      INCBIN "gfx/pokemon/pallazip/front.animated.2bpp.lz"
...
ClefairyFrontpic:    INCBIN "gfx/pokemon/guarden/front.animated.2bpp.lz"
...
CleffaFrontpic:      INCBIN "gfx/pokemon/comphost/front.animated.2bpp.lz"
...
ClefableBackpic:     INCBIN "gfx/pokemon/maractus/back.2bpp.lz"
DoduoFrontpic:       INCBIN "gfx/pokemon/doduo/front.animated.2bpp.lz"
HallucigonBackpic:   INCBIN "gfx/pokemon/hallucigon/back.2bpp.lz"
...
PupageBackpic:    INCBIN "gfx/pokemon/pupage/back.2bpp.lz"
TeddyawnBackpic:      INCBIN "gfx/pokemon/teddyawn/back.2bpp.lz"
...
StaguardBackpic:      INCBIN "gfx/pokemon/staguard/back.2bpp.lz"
RavetileBackpic:     INCBIN "gfx/pokemon/ravetile/back.2bpp.lz"
...
BeedrillBackpic:     INCBIN "gfx/pokemon/geodent/back.2bpp.lz"
...
MandibladeBackpic:   INCBIN "gfx/pokemon/mandiblade/back.2bpp.lz"
...
SteelixBackpic:      INCBIN "gfx/pokemon/moggibox/back.2bpp.lz"
...
OnixBackpic:         INCBIN "gfx/pokemon/pugilhiss/back.2bpp.lz"
...
FlaaffyBackpic:      INCBIN "gfx/pokemon/pallazap/back.2bpp.lz"
SentretFrontpic:     INCBIN "gfx/pokemon/sentret/front.animated.2bpp.lz"
TogeticBackpic:      INCBIN "gfx/pokemon/togekiss/back.2bpp.lz"
...
IgglybuffFrontpic:   INCBIN "gfx/pokemon/bouqute/front.animated.2bpp.lz"
...
MareepBackpic:       INCBIN "gfx/pokemon/pallazip/back.2bpp.lz"
...
WooperFrontpic:      INCBIN "gfx/pokemon/croagunk/front.animated.2bpp.lz"
ClefairyBackpic:     INCBIN "gfx/pokemon/guarden/back.2bpp.lz"
...
HarlyenaBackpic:      INCBIN "gfx/pokemon/harlyena/back.2bpp.lz"
...
KakunaFrontpic:      INCBIN "gfx/pokemon/minerat/front.animated.2bpp.lz"
...
WeedleFrontpic:      INCBIN "gfx/pokemon/squeakrag/front.animated.2bpp.lz"
ReptripBackpic:     INCBIN "gfx/pokemon/reptrip/back.2bpp.lz"
...
UrsamimirBackpic:     INCBIN "gfx/pokemon/ursamimir/back.2bpp.lz"
PicnickerPic:        INCBIN "gfx/trainers/picnicker.2bpp.lz"
LickitungBackpic:    INCBIN "gfx/pokemon/lickitung/back.2bpp.lz"
TogepiFrontpic:      INCBIN "gfx/pokemon/togetic/front.animated.2bpp.lz"
...
QuagsireBackpic:     INCBIN "gfx/pokemon/toxicroak/back.2bpp.lz"
...
KakunaBackpic:       INCBIN "gfx/pokemon/minerat/back.2bpp.lz"
WobbuffetBackpic:    INCBIN "gfx/pokemon/wobbuffet/back.2bpp.lz"
TogepiBackpic:       INCBIN "gfx/pokemon/togetic/back.2bpp.lz"
CrobatBackpic:       INCBIN "gfx/pokemon/crobat/back.2bpp.lz"
BlisseyBackpic:      INCBIN "gfx/pokemon/blissey/back.2bpp.lz"
AmpharosBackpic:     INCBIN "gfx/pokemon/cyclizar/back.2bpp.lz"
IgglybuffBackpic:    INCBIN "gfx/pokemon/bouqute/back.2bpp.lz"
...
WigglytuffBackpic:   INCBIN "gfx/pokemon/togepi/back.2bpp.lz"
...
WooperBackpic:       INCBIN "gfx/pokemon/croagunk/back.2bpp.lz"
...
TogeticFrontpic:     INCBIN "gfx/pokemon/togekiss/front.animated.2bpp.lz"
...
LullabearBackpic:    INCBIN "gfx/pokemon/lullabear/back.2bpp.lz"
...
JigglypuffBackpic:   INCBIN "gfx/pokemon/blossaroma/back.2bpp.lz"
