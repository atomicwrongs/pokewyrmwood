...
; entries correspond to STARTMENUITEM_* constants
	dw StartMenu_Pokedex,  .PokedexString,  .Clock
	dw StartMenu_Pokemon,  .PartyString,    .Clock
	dw StartMenu_Pack,     .PackString,     .Clock
	dw StartMenu_Status,   .StatusString,   .Clock
	dw StartMenu_Save,     .SaveString,     .Clock
	dw StartMenu_Option,   .OptionString,   .Clock
	dw StartMenu_Exit,     .ExitString,     .Clock
	dw StartMenu_Pokegear, .PokegearString, .Clock
	dw StartMenu_Quit,     .QuitString,     .Clock
