...
; NPCTrades indexes (see data/events/npc_trades.asm)
	const_def
	const NPC_TRADE_SADAKO   ; 0
	const NPC_TRADE_FRAN   ; 1
	const NPC_TRADE_JEANLUC   ; 2
	const NPC_TRADE_GABRIEL   ; 3
	const NPC_TRADE_CHRIS ; 4
	const NPC_TRADE_HYACINCTH   ; 5
	const NPC_TRADE_CHESTER ; 6
	const NPC_TRADE_PEPPER ; 7
