...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_TARRAGON
	const ENGINE_FLYPOINT_CHAMOMILE
	const ENGINE_FLYPOINT_TAURIC
;	const ENGINE_FLYPOINT_JACARANDA
;	const ENGINE_FLYPOINT_CAMPHOR
;	const ENGINE_FLYPOINT_PASSIFLORA
;	const ENGINE_FLYPOINT_HIBISCUS
;	const ENGINE_FLYPOINT_PERSIMMON
;	const ENGINE_FLYPOINT_GOLDENSEAL
;	const ENGINE_FLYPOINT_DREAMWORLD
