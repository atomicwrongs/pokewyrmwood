...
; - BattleAnimations (see data/moves/animations.asm)
	...
	const DRAGON_PULSE ; 1c
	const HEADBUTT     ; 1d
	const HORN_ATTACK  ; 1e
	const FURY_ATTACK  ; 1f
	const DARK_PULSE   ; 20
	const TACKLE       ; 21
	const AURA_SPHERE   ; 22
	const PSYSTRIKE    ; 23
	const TAKE_DOWN    ; 24
	const THRASH       ; 25
	...
	const FIRE_BLAST   ; 7e
	const WATERFALL    ; 7f
	const GLACIALBLADE       ; 80
	const SWIFT        ; 81
	const SKULL_BASH   ; 82
	const SPIKE_CANNON ; 83
	const PIXIE_PUNCH    ; 84
	const AMNESIA      ; 85
	const FAIRY_DUST      ; 86
	const SOFTBOILED   ; 87
	...
	const DRAGON_CLAW  ; 8b
	const WYVERN_BEAM      ; 8c
	const LEECH_LIFE   ; 8d
	const HAUNT  ; 8e
	const SWINDLE   ; 8f
	const NIGHT_SLASH   ; 90
	const WINGBEAT       ; 91
	const DIZZY_PUNCH  ; 92
	const BRAVE_BIRD        ; 93
	const SKYDIVE        ; 94
	const ARMOUR_BREAK    ; 95
	const SWEET_STRIKE      ; 96
	const ACID_ARMOR   ; 97
	const CRABHAMMER   ; 98
	const EXPLOSION    ; 99
	const LEAF_BLADE  ; 9a
