...
; Johto story events
	...
	const EVENT_LULLABALL
	const EVENT_REPTRIPBALL
	const EVENT_PUPAGEBALL
	const EVENT_TOOK_LULLABALL
	const EVENT_TOOK_PUPAGEBALL
	const EVENT_TOOK_REPTRIPBALL
	const EVENT_VALERIAN_BROKEBALL
	...
	const EVENT_TARRAGON_POKEBALL
	const EVENT_TARRAGONPOKECENTER_POTION
	const EVENT_BILBERRY_REPEL
	const EVENT_MOUNTAIN_KITS
	const EVENT_TALKED_TO_KITS
	const EVENT_MOUNTAIN_KITS_2
	...
	const_skip ; unused
	const_skip ; unused
	const EVENT_JACARANDA_NIA
	const EVENT_JAC_SADBOY
...
; Bird Keeper
	...
	const EVENT_BEAT_YOUNGSTER_TIM
...
; Crystal-exclusive trainer flags
	const EVENT_BEAT_ARIADOS_SWARM_1
	const EVENT_BEAT_ARIADOS_SWARM_2
	const EVENT_BEAT_ARIADOS_SWARM_3
	const EVENT_BEAT_ARIADOS_SWARM_4
	const EVENT_BEAT_ARIADOS_SWARM_5
...
; Johto itemballs
	...
	const EVENT_TARRAGON_MART_BALL1
	const EVENT_TARRAGON_MART_BALL2
	const EVENT_CHAMOMILE_GREAT_BALL
	...
	const EVENT_CHAMOMILE_PIKACHU
	const EVENT_TARRAGON_GREATBALL
	const EVENT_TARRAGON_SNUBBULL
	const EVENT_BILBERRY_POKEBALL
	const EVENT_BILBERRY_ANTIDOTE
	const EVENT_BILBERRY_POTION
	const EVENT_101_LUCKYEGG
	const EVENT_101_MAXREVIVE
	const EVENT_101_POTION
	const EVENT_BILBERRY_SHINY_ARIADOS
	const EVENT_BILBERRY_CASH
	const EVENT_BILBERRY_TM
	const EVENT_BILBERRY_TALIS
	const EVENT_BILBERRY_POWDER
	const EVENT_BILBERRY_XATTA
	const EVENT_CHAMO_GYM_BALL
	const EVENT_BASIL_POTION
	const EVENT_BASIL_REVIVE
	const EVENT_BASIL_BALL
	const EVENT_BASIL_REPEL
	const EVENT_GINGER_SUPERPOTION
	const EVENT_GINGER_PIECE
	const EVENT_GINGER_COAT
	const EVENT_GINGER_QUAKE
	const EVENT_VALERIAN_ELIXIR
...
; Johto people
	const EVENT_LEE_CHAMOMILECITY
	const EVENT_ROUTE102_OLD_MAN
	...
	const EVENT_ROUTE101_PRANKGIRL
	const EVENT_BILBERRY_SCAREDGUY
	const EVENT_PLAYED_BASKETBALL
...
; Unused: next 48 events
	const EVENT_LITTLESAGE_BIRTHDAY
