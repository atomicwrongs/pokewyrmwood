...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          20, NORMAL,        PHYSICAL,  85, 10,   0
	move PLAY_ROUGH,   EFFECT_ATTACK_DOWN_HIT,    80, FAIRY,         PHYSICAL,  90, 15,  20
	move MOONBLAST,    EFFECT_SP_DEF_DOWN_HIT,    90, FAIRY,         SPECIAL,  100, 10,  20
	...
	move CUT,          EFFECT_LEECH_HIT,          50, FAIRY,         PHYSICAL, 100, 20,   0
	...
	move FLY,          EFFECT_FLY,                80, FLYING,        PHYSICAL,  95, 15,   0
	move FLASH_CANNON, EFFECT_ACCURACY_DOWN_HIT,  90, STEEL,         SPECIAL,  100, 10,  30
	move SLAM,         EFFECT_NORMAL_HIT,         80, NORMAL,        PHYSICAL,  75, 20,   0
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         35, GRASS,         PHYSICAL, 100, 10,   0
	move SEA_BLADE,    EFFECT_NORMAL_HIT,         75, WATER,         PHYSICAL, 100, 20,   0
	move DOUBLE_KICK,  EFFECT_DOUBLE_HIT,         30, FIGHTING,      PHYSICAL, 100, 30,   0
	move APOPLEXY,     EFFECT_RAMPAGE,           100, FIRE,          PHYSICAL,  95,  10,  0
	...
	move DRAGON_PULSE, EFFECT_NORMAL_HIT,         80, DRAGON,        SPECIAL,  100, 10,   0
	...
	move DARK_PULSE,   EFFECT_NORMAL_HIT,         80, DARK,          SPECIAL,  100, 15,   0
	move TACKLE,       EFFECT_NORMAL_HIT,         35, NORMAL,        PHYSICAL,  95, 35,   0
	move AURA_SPHERE,  EFFECT_NORMAL_HIT,         85, FIGHTING,      SPECIAL,  100, 15,   0
	move PSYSTRIKE,    EFFECT_NORMAL_HIT,         80, PSYCHIC_TYPE,  PHYSICAL, 100, 20,   0
	...
	move HIVE_MIND,    EFFECT_BEAT_UP,            30, BUG,           PHYSICAL, 100, 15,   0
	move ACCELEROCK,   EFFECT_PRIORITY_HIT,       40, ROCK,          PHYSICAL, 100, 20,   0
	...
	move STONE_EDGE,   EFFECT_NORMAL_HIT,        100, ROCK,          PHYSICAL, 90,   5,   0
	...
	move STRENGTH,     EFFECT_NORMAL_HIT,         80, ICE,           PHYSICAL, 100, 15,   0
	...
	move ICE_PICK,     EFFECT_DEFENSE_DOWN_HIT,   60, ICE,           PHYSICAL, 100, 20,  30
	...
	move METEOR_MASH,  EFFECT_ATTACK_UP_HIT,      90, STEEL,         PHYSICAL,  90, 20,  10
	...
	move BUG_BUZZ,     EFFECT_SP_DEF_DOWN_HIT,    80, BUG,           SPECIAL,  100, 30,  20
	move PHANTOMFORCE, EFFECT_FLY,               100, GHOST,         PHYSICAL, 100, 10,   0
	move SMOKESCREEN,  EFFECT_ACCURACY_DOWN,       0, NORMAL,        STATUS,   100, 20,   0
	move CONFUSE_RAY,  EFFECT_CONFUSE,             0, GHOST,         STATUS,   100, 10,   0
	move SCALD,        EFFECT_BURN_HIT,           90, WATER,         SPECIAL,  100, 10,  20
	...
	move POWERPUNCH,   EFFECT_ATTACK_UP_HIT,      60, FIGHTING,      PHYSICAL, 100, 20, 100
	...
	move GLACIALBLADE, EFFECT_FREEZE_HIT,         90, ICE,         PHYSICAL,  100, 10,   20
	...
	move PIXIE_PUNCH,  EFFECT_ATTACK_DOWN_HIT,    75, FAIRY,        PHYSICAL,  100, 15,  10
	move AMNESIA,      EFFECT_SP_DEF_UP_2,         0, PSYCHIC_TYPE,  STATUS,   100, 20,   0
	move FAIRY_DUST,   EFFECT_TRI_ATTACK,         20, FAIRY,         STATUS,   100, 15,  40
	...
	move DRAGON_CLAW,  EFFECT_NORMAL_HIT,         75, DRAGON,        PHYSICAL, 100, 10,   0
	move WYVERN_BEAM,  EFFECT_NORMAL_HIT,        110, DRAGON,        SPECIAL,   85, 10,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          20, BUG,           PHYSICAL, 100, 15,   0
	move HAUNT,        EFFECT_ROLLOUT,            40, GHOST,         SPECIAL,   75, 10,   0
	move SWINDLE,      EFFECT_PAY_DAY,            40, DARK,          PHYSICAL, 100, 40,   0
	move NIGHT_SLASH,  EFFECT_FLINCH_HIT,         80, DARK,          PHYSICAL, 100, 10,  20
	move WINGBEAT,     EFFECT_DOUBLE_HIT,         50, FLYING,        PHYSICAL, 100, 30,   0
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, NORMAL,        PHYSICAL, 100, 10,  20
	move BRAVE_BIRD,   EFFECT_RECOIL_HIT,        100, FLYING,        PHYSICAL, 100, 10,   0
	move SKYDIVE,      EFFECT_JUMP_KICK,         100, FLYING,        PHYSICAL,  85, 20,   0
	move ARMOUR_BREAK, EFFECT_DEFENSE_DOWN_HIT,   80, STEEL,         PHYSICAL, 100, 15, 100
	move SWEET_STRIKE, EFFECT_NORMAL_HIT,         75, FAIRY,         PHYSICAL, 100, 20,   0
	...
	move LEAF_BLADE,   EFFECT_NORMAL_HIT,         80, GRASS,        PHYSICAL,  100, 15,   0
	...
	move NOCTURNE,     EFFECT_NORMAL_HIT,        120, DARK,          SPECIAL,   90, 10,   0
	move SHARPEN,      EFFECT_ATTACK_UP,           0, NORMAL,        STATUS,   100, 30,   0
	move PYRO_BLADE,   EFFECT_BURN_HIT,           90, FIRE,          PHYSICAL, 100, 10,  20
	...
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        30, ICE,           PHYSICAL,  90, 10,   0
	move THIEF,        EFFECT_THIEF,              40, DARK,          PHYSICAL, 100, 10, 100
	move SPIDER_WEB,   EFFECT_MEAN_LOOK,           0, BUG,           STATUS,   100, 10,   0
	move OOZE_STORM,  EFFECT_RAMPAGE,            100, POISON,        SPECIAL,   90,  10,  0
	...
	move PESTILENCE,   EFFECT_POISON_HIT,        120, POISON,        SPECIAL,  50,   5, 100
	...
	move GALE_FORCE,   EFFECT_SPEED_DOWN_HIT,     90, FLYING,        SPECIAL,  100, 10,  50
	...
	move MIND_SPIKE,   EFFECT_FLINCH_HIT,         75, PSYCHIC_TYPE,  SPECIAL,   90, 10,  50
	...
	move TIDAL_CRASH,  EFFECT_RECOIL_HIT,        100, WATER,         PHYSICAL,  90, 10,   0
	...
	move LOVE_ARROW,   EFFECT_SP_DEF_DOWN_HIT,    80, FAIRY,         SPECIAL,  100, 15,  30
	...
	move TERRIFY,      EFFECT_PARALYZE_HIT,       100, GHOST,        SPECIAL,  100, 10,  40
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,         PHYSICAL,  80, 10,  50
