...
MimicDescription:
	db   "Slashes the enemy"
	next "in an X pattern.@"
...
HardenDescription:
	db   "A harsh buzz that"
	next "may lower WIL.@"

MinimizeDescription:
	db   "Vanishes and"
	next "attacks next turn.@"
...
TransformDescription:
	db   "Lashes out with a"
	next "night-dark blade.@"

BubbleDescription:
	db   "Strikes foes with"
	next "two wingbeats.@"
...
FlashDescription:
	db   "Harms the user if"
	next "it misses the foe.@"
...
FaintAttackDescription:
	db   "Attacks from behind"
	next "to never miss.@"

SweetKissDescription:
	db   "Lowers foe SPD"
	next "with high winds.@"
