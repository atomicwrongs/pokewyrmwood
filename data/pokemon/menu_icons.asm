...
MonMenuIcons:
	...
	db ICON_FOX         ; LULLABEAR
	db ICON_MONSTER     ; BAYLEEF
	db ICON_MONSTER      ; MEGANIUM
	db ICON_BUG         ; CYNDAQUIL
	db ICON_BUG         ; QUILAVA
	db ICON_BUG         ; TYPHLOSION
	db ICON_BLOB     ; TOTODILE
	db ICON_BLOB     ; CROCONAW
	db ICON_BLOB     ; FERALIGATR
	db ICON_FOX         ; SENTRET
	db ICON_FOX         ; FURRET
