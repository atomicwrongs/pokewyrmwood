...
; entries correspond to constants/pokemon_constants.asm
	...
	dw MewPokedexEntry
	dw LullabearPokedexEntry
	dw TeddyawnPokedexEntry
	dw UrsamimirPokedexEntry
	dw PupagePokedexEntry
	dw StaguardPokedexEntry
	dw MandibladePokedexEntry
	dw ReptripPokedexEntry
	dw RavetilePokedexEntry
	dw HallucigonPokedexEntry
