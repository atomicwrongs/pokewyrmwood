...
IcyPendantDesc:
	db   "A frosty necklace."
	next "Cold to the touch.@"
...
FireStoneDesc:
	db   "A mote of flame"
	next "preserved forever.@"

ThunderStoneDesc:
	db   "A brilliant spark"
	next "dances inside.@"

WaterStoneDesc:
	db   "Emanates the might"
	next "of the ocean.@"
...
LeafStoneDesc:
	db   "The forest's will"
	next "radiates from it.@"

EerieRagDesc:
	db   "A shred of cloth"
	next "with a dark aura.@"
