...
.JohtoStarters: db BUENA_MON,    10, PUPAGE, REPTRIP, LULLABEAR
...
.Pokemon1:      db BUENA_MON,    10, PIKACHU, BUNEARY, CUBTERRA
.Pokemon2:      db BUENA_MON,    10, HOOTHOOT, SPINARAK, SIGILYPH
