...
; BattleTowerMons group 1
	...
	db CHESNAUGHT
	db QUICK_CLAW
	db HEADBUTT, SOLARBEAM, ROLLOUT, SLAM
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 32000
...
; BattleTowerMons group 2
	...
	db PIKACHU
	db LIGHT_BALL
	db THUNDERBOLT, STUN_SPORE, SLAM, TOXIC
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SIMISEER
	db GOLD_BERRY
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, SLAM
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GUARDEN
	db PINK_BOW
	db PSYCHIC_M, SWAGGER, CALM_MIND, HEADBUTT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 3
	...
	db JOLTEON
	db MIRACLEBERRY
	db THUNDERBOLT, STUN_SPORE, ROAR, MUD_SLAP
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db FINNEON
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, GUILLOTINE, SUBMISSION
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db STARMIE
	db LEFTOVERS
	db STUN_SPORE, PSYCHIC_M, RECOVER, SURF
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PANSULK
	db MIRACLEBERRY
	db POWERPUNCH, ICE_PUNCH, EARTHQUAKE, FIRE_BLAST
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db LAPRAS
	db LEFTOVERS
	db RAIN_DANCE, WATER_GUN, ICY_WIND, SLAM
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db KILOWATREL
	db KINGS_ROCK
	db SLAM, TOXIC, SLUDGE_BOMB, BUBBLEBEAM
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHERRIM
	db BRIGHTPOWDER
	db SUNNY_DAY, SOLARBEAM, FIRE_SPIN, LEECH_SEED
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 4
	...
	db BRIONNE
	db QUICK_CLAW
	db ATTRACT, SLAM, CALM_MIND, EARTHQUAKE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db URSTEEL
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, SLAM, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db CHESPIN
	db NO_ITEM
	db SPARK, THUNDERBOLT, PSYBEAM, THIEF
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db JUNKANINE
	db BRIGHTPOWDER
	db LEAF_BLADE, SLAM, CALM_MIND, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 5
	...
	db BRIONNE
	db LEFTOVERS
	db HYPER_BEAM, EARTHQUAKE, SURF, CALM_MIND
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db JOLTEON
	db KINGS_ROCK
	db THUNDERBOLT, STUN_SPORE, SHADOW_BALL, HIDDEN_POWER
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db PANSULK
	db GOLD_BERRY
	db POWERPUNCH, EARTHQUAKE, FIRE_BLAST, THUNDERPUNCH
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db STARMIE
	db SCOPE_LENS
	db STUN_SPORE, RECOVER, THUNDERBOLT, SURF
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db SERENOSE
	db MIRACLEBERRY
	db SKYDIVE, THUNDERBOLT, STUN_SPORE, HYPER_BEAM
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 45000
...
; BattleTowerMons group 6
	...
	db PANSULK
	db QUICK_CLAW
	db FIRE_PUNCH, POWERPUNCH, THUNDERPUNCH, EARTHQUAKE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SERENOSE
	db MINT_BERRY
	db REST, SKYDIVE, THUNDERBOLT, STUN_SPORE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db UMBRAELLA
	db GOLD_BERRY
	db HYPNOSIS, GIGA_DRAIN, HYPER_BEAM, SLUDGE_BOMB
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 7
	...
	db UMBREON
	db GOLD_BERRY
	db FAINT_ATTACK, MOONLIGHT, CALM_MIND, TOXIC
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 54000
	...
	db SERENOSE
	db GOLD_BERRY
	db THUNDERBOLT, SKYDIVE, STUN_SPORE, HYPER_BEAM
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db PRIMEAPE
	db QUICK_CLAW
	db POWERPUNCH, ICE_PUNCH, THUNDERPUNCH, ROCK_SLIDE
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PANSEER
	db FOCUS_BAND
	db REVERSAL, ENDURE, SLAM, TRIPLE_KICK
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 8
	...
	db JOLTEON
	db MIRACLEBERRY
	db STUN_SPORE, THUNDERBOLT, IRON_TAIL, ROAR
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db DIANCIE
	db GOLD_BERRY
	db STUN_SPORE, SURF, THUNDERBOLT, OUTRAGE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CELESNOUT
	db CHARCOAL
	db FLAMETHROWER, FLY, STEEL_WING, HYPER_BEAM
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CHARGETIC
	db GOLD_BERRY
	db HYPER_BEAM, SUBMISSION, SLAM, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 9
	...
	db PANSULK
	db QUICK_CLAW
	db POWERPUNCH, VITAL_THROW, FIRE_BLAST, EARTHQUAKE
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 55000
...
; BattleTowerMons group 10
	...
	db PANSULK
	db QUICK_CLAW
	db POWERPUNCH, EARTHQUAKE, HYPER_BEAM, VITAL_THROW
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db JOLTEON
	db BRIGHTPOWDER
	db THUNDERBOLT, ROAR, STUN_SPORE, IRON_TAIL
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SHIVERKIT
	db BRIGHTPOWDER
	db STUN_SPORE, THUNDERBOLT, EXPLOSION, MIRROR_COAT
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db CHERRIM
	db KINGS_ROCK
	db SOLARBEAM, SUNNY_DAY, MORNING_SUN, FIRE_SPIN
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 55000
