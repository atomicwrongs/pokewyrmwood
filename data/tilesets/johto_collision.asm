	...
	tilecoll WALL, WARP_CARPET_UP, FLOOR, FLOOR ; 20
	tilecoll WARP_CARPET_UP, WALL, FLOOR, FLOOR ; 21
	...
	tilecoll BUOY, WALL, WATER, WATER ; 2f
	...
	tilecoll WALL, BUOY, WATER, WATER ; 3b
