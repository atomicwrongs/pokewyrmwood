...
.Dratini_Super:
	...
	db  90 percent + 1, MAGIKARP,   40
	db 100 percent,     POPPLIO,  40

.Qwilfish_Swarm_Old:
	db  70 percent + 1, MAGIKARP,   5
	db  85 percent + 1, MAGIKARP,   5
	db 100 percent,     VELUZA,   5
.Qwilfish_Swarm_Good:
	db  35 percent,     MAGIKARP,   20
	db  70 percent,     VELUZA,   20
	db  90 percent + 1, VELUZA,   20
	db 100 percent,     time_group 10
.Qwilfish_Swarm_Super:
	db  40 percent,     VELUZA,   40
	db  70 percent,     time_group 11
	db  90 percent + 1, VELUZA,   40
	db 100 percent,     VELUZA,   40
...
TimeFishGroups:
	;  day              nite
	db SPLASHFUL,    20,  STARYU,     20 ; 0
	db SPLASHFUL,    40,  STARYU,     40 ; 1
	...
	db VELUZA,   40,  VELUZA,   40 ; 11
	db FINNEON,   20,  FINNEON,   20 ; 12
	db FINNEON,   40,  FINNEON,   40 ; 13
	db GYARADOS,   20,  GYARADOS,   20 ; 14
	db GYARADOS,   40,  GYARADOS,   40 ; 15
	db BREAMING,    10,  BREAMING,    10 ; 16
	db BREAMING,    10,  BREAMING,    10 ; 17
	db HORSEA,     20,  HORSEA,     20 ; 18
	db HORSEA,     40,  HORSEA,     40 ; 19
	db CORPHISH,  20,  CORPHISH,  20 ; 20
	db CORPHISH,  40,  CORPHISH,  40 ; 21
